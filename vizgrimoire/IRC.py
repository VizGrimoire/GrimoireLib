...
class IRC(DataSource):
    ...
    def get_evolutionary_data (period, startdate, enddate, identities_db, filter_ = None):
        metrics = IRC.get_metrics_data(period, startdate, enddate, identities_db, filter_, True)
    ...
    def get_agg_data (period, startdate, enddate, identities_db, filter_ = None):
        metrics = IRC.get_metrics_data(period, startdate, enddate, identities_db, filter_, False)
        if filter_ is not None: studies = {}
        else:
            studies = IRC.get_metrics_data(period, startdate, enddate, True)
        return dict(metrics.items()+studies.items())
