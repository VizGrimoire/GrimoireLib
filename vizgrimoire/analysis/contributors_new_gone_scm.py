...
class ContributorsNewGoneSCM(ContributorsNewGone):
    ...
    def get_report_files(self, destdir):
        return ["scm-people-intake-evolutionary.json",
                "gone-people-activity-scm-evolutionary.json",
                "new-people-activity-scm-evolutionary.json",
                "scm-code-contrib-gone.json",
                "scm-code-contrib-new.json"]
