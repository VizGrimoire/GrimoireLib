...
class Sent(Metrics):
    ...
    def __get_sql__(self, evolutionary):
        ...
        tables = " messages m " + self.db.GetSQLReportFrom(self.db.identities_db, self.filters.type_analysis)
        filters = self.db.GetSQLReportWhere(self.filters.type_analysis, self.db.identities_db)
        q = self.db.BuildQuery(self.filters.period, self.filters.startdate, self.filters.enddate, 
                               " m.first_date ", fields, tables, filters, evolutionary)
...
if __name__ == '__main__':
    ...
    dbcon = MLSQuery("root", "", "cp_bicho_SingleProject", "cp_bicho_SingleProject",)
